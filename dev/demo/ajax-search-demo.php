...
// Add support for 'search_term' query var, theme-functions.php
...
// localize theme scripts, organic_theme_enqueue_assets, timber-functions.php 
wp_localize_script(
  'organic-theme-js',
  'myAjax',
  array(
